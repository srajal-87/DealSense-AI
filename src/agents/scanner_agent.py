...
class ScannerAgent(Agent):
    ...
    def __init__(self):
        ...
        self.log("Scanner Agent is setting up OpenAI client")
    ...
    def scan(self, memory: List[str] = [], selected_feeds=None) -> Optional[DealSelection]:
        """
        ...
        if scraped:
            ...
            try:
                ...
                self.log(f"❌ Scanner Agent encountered an error calling OpenAI: {e}")
                return None
